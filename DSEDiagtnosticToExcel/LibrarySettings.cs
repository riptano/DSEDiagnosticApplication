...
namespace DSEDiagtnosticToExcel
{
    ...
    {
        public static Dictionary<string, DataTableToExcel.WorkSheetColAttrDefaults[]> WorkSheetDefaultAttrs = DSEDiagnosticParamsSettings.Helpers.ReadJsonFileIntoObject<Dictionary<string, DataTableToExcel.WorkSheetColAttrDefaults[]>>(Properties.Settings.Default.WorkSheetDefaultAttrs);
