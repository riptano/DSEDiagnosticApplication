...
{
    public sealed class PFTombstonesExcel : PFExcel
    {
        public const string DataTableName = DSEDiagnosticToDataTable.TableNames.PFTombstonesTable;

        public PFTombstonesExcel(DataTable keyspaceDataTable,
        ...
        {
            this.DataTable.SetGroupHeader("Tombstone/Live Ratio", -1, true,
