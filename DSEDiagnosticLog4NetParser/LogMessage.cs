...
namespace DSEDiagnosticLog4NetParser
{
    ...
    public sealed class LogMessages : ILogMessages
    {
        ...
        public LogMessages(IFilePath logFile, string log4netConversionPattern)
        {
        ...
        public LogMessage AddMessage(string logLine, uint logLinePos)
        {
            ...
            else if(this._lastMessage != null)
            {
                ...
                {
                    var error = string.Format("\t{0}\tInvalid line detected ({1}) in Log4Net Log file at line number {2}. Line ignored.",
            ...
            if(this._logTimestampValue)
            {
                ...
                {
                    var error = string.Format("\t{0}\tInvalid Timestamp detected ({1}) in line \"{2}\" within Log4Net Log file at line number {3}. Line ignored.",
                                                this.LogFile.PathResolved,
            ...
            else
            {
                ...
                {
                    var error = string.Format("\t{0}\tInvalid DateTime detected ({1}) in line \"{2}\" within Log4Net Log file at line number {3}{4}. Line ignored.",
                                                this.LogFile.PathResolved,
            ...
            #region Log Level
            {
                ...
                {
                    var error = string.Format("\t{0}\tInvalid Log Level detected ({1}) in line \"{2}\" within Log4Net Log file at line number {3}. Line ignored.",
                                                this.LogFile.PathResolved,
            ...
            #region Log File Line
            {
                ...
                {
                    var error = string.Format("\t{0}\tInvalid Log File Line detected ({1}) in line \"{2}\" within Log4Net Log file at line number {3}. Line ignored.",
                                                this.LogFile.PathResolved,
