...
namespace DSEDiagnosticFileParser
{
    ...
    public sealed class file_unzip : DiagnosticFile
    {
        ...
        {           
            ...
            nbrFilesExtracted = MiscHelpers.UnZipFileToFolder(this.File, out IDirectoryPath newDirectory, false, extractToParentFolder, true, true, this.CancellationToken, false);
