...
{
    public sealed class PFSSTablesDataTable : DataTableLoad
    {
        public PFSSTablesDataTable(DSEDiagnosticLibrary.Cluster cluster,
        ...
        {
            var dtPF = new DataTable(TableNames.PFSSTablesTables, this.SourceTable.Namespace);
            ...
            dtPF.Columns.Add(TaggedItemsDataTable.Columns.SSTablesMax, typeof(long))
                                .AllowDBNull();
            dtPF.Columns.Add(TaggedItemsDataTable.Columns.SSTablesMin, typeof(long))
                                .AllowDBNull();
            dtPF.Columns.Add(TaggedItemsDataTable.Columns.SSTablesAvg, typeof(decimal))
                                .AllowDBNull();
        ...
        public override DataTable LoadTable()
        {
            ...
            try
            {
                ...
                var taggedItems = from dataRow in this.SourceTable.AsEnumerable()
                                  where !dataRow.IsNull(TaggedItemsDataTable.Columns.SSTablesFactor)
                                  ...
                                  let dcfactors = grp.Select(i => new
                                  {
                                      ...
                                      Factor = i.Field<decimal>(TaggedItemsDataTable.Columns.SSTablesFactor)
                                  })
                                  ...
                                  select new
                                  {
                                      ...
                                      DCFactor = dcfactors,
                                      SSTablePercent = grp.Sum(r => r.Field<decimal>(TaggedItemsDataTable.Columns.SSTablePercent)),
                                      SSTableMax = grp.Max(r => r.Field<long>(TaggedItemsDataTable.Columns.SSTablesMax)),
                                      SSTableMin = grp.Where(r => !r.IsNull(TaggedItemsDataTable.Columns.SSTablesMin))
                                                    .ActionIfNotEmpty(i => i.Min(r => r.Field<long>(TaggedItemsDataTable.Columns.SSTablesMin)), default(long?)),
                                      SSTableAvg = grp.Where(r => !r.IsNull(TaggedItemsDataTable.Columns.SSTablePercent))
                                                    .ActionIfNotEmpty(i => i.Min(r => r.Field<decimal>(TaggedItemsDataTable.Columns.SSTablePercent)), default(decimal?)),
                ...
                foreach (var factors in taggedItems)
                {
                    ...
                    newDataRow.SetField(TaggedItemsDataTable.Columns.SSTablesMax, factors.SSTableMax);
                    newDataRow.SetField(TaggedItemsDataTable.Columns.SSTablesMin, factors.SSTableMin);
                    newDataRow.SetField(TaggedItemsDataTable.Columns.SSTablesAvg, factors.SSTableAvg);
